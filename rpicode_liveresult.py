...
def run(model: str, num_hands: int,
  ...
  while cap.isOpened():
    ...
    # hand center x and y are the middle of the input frame size
    hand_center_x = .5
    hand_center_y = .5
    if recognition_result_list and recognition_result_list[0].gestures:
        print("check_input")
        Gui.check_input(recognition_result_list[0].gestures[0][0].category_name, (hand_center_x, hand_center_y), (recognition_frame.shape[1], recognition_frame.shape[0]))
